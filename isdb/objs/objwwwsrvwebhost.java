 ...
 * для використання функції "Розмiщення Web-сторiнок".
 * @version 1.0 final, 6-V-2000
 * @author Yermolenko Vitaly, Utel-Zhitomir
 */
public class objwwwsrvwebhost extends objwwwservice
{
    ...
    public String desc (String strNameField)
    {
        if (strNameField.equals (COL_SRVVALUE1))
            return htmli.center ("Необхід. дисковий простір (в мегабайтах)");
    ...
    {
        return "Розмiщення Web-сторiнок";
    }
    ...
    public void listproperty (dbdata oDBData, outdata oOutData)
    {
        ...
        oSQLData.setWhere ("WWWSERV_ID='" + SRV_WEBHOST + "'");
    ...
    public String fields (dbdata oDBData, outdata oOutData)
    {
        ...
        if (oDBData.isRegime (isdb.miscs.dclrs.REGIME_INSERT))
        {
            ...
            oOutData.setFld (COL_SRVVALUE1, field (COL_SRVVALUE1, "", 5, oOutData, true));
        ...
        else    // оновлення або вибірка інформації?
        {
            ...
            {
                oOutData.setFld (COL_SRVVALUE2, field (COL_SRVVALUE1, oDBData, oOutData));
                oOutData.setFld (COL_SRVVALUE2, field (COL_SRVVALUE2, oDBData, oOutData));
        ...
        return
          ...
          htmli.paragraph ("Інформація про встановлення послуги",
                           htmli.cell (oOutData.getFld (COL_SRVVALUE1), 40) +
                           htmli.cell (oOutData.getFld (COL_SRVVALUE2) +
                                       htmli.crlf () +
                                       oOutData.getFld (COL_SRVVALUE3), 40) +
                           htmli.cell (oOutData.getFld (COL_STARTDATE), 20)) +
    ...
    {
        oDBData.setVal (COL_WWWSERV_ID, SRV_WEBHOST);
