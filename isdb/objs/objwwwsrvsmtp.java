 ...
 * для використання функції "Підтримка поштового серверу (SMTP)".
 * @version 1.0 final, 1-IV-2000
 * @author Yermolenko Vitaly, Utel-Zhitomir
 */
public class objwwwsrvsmtp extends objwwwservice
{
    ...
    {
        return "Підтримка поштового серверу (SMTP)";
    }
    ...
    public void listproperty (dbdata oDBData, outdata oOutData)
    {
        ...
        oSQLData.setWhere ("WWWSERV_ID='" + SRV_SMTP + "'");
    ...
    public String fields (dbdata oDBData, outdata oOutData)
    {
        ...
        return
          ...
          htmli.paragraph ("Інформація про встановлення послуги",
                           ...
                           htmli.cell (oOutData.getFld ("STARTDATE"), 50)) +
    ...
    {
        oDBData.setVal (COL_WWWSERV_ID, SRV_SMTP);
