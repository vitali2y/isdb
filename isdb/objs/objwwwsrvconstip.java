 ...
 * для використання функції "Постiйнi IP-адреси".
 * @version 1.0 final, 6-V-2000
 * @author Yermolenko Vitaly, Utel-Zhitomir
 */
public class objwwwsrvconstip extends objwwwservice
{
    ...
    public String desc (String strNameField)
    {
        if (strNameField.equals (COL_SRVVALUE1))
            return htmli.center ("Постiйна IP-адреса");
    ...
    public void listproperty (dbdata oDBData, outdata oOutData)
    {
        ...
        oSQLData.setWhere ("WWWSERV_ID='" + SRV_CONSTIP + "'");
    ...
    {
        oDBData.setVal (COL_WWWSERV_ID, SRV_CONSTIP);
