 ...
 * для використання функції "Послуга DNS".
 * @version 1.0 final, 6-V-2000
 * @author Yermolenko Vitaly, Utel-Zhitomir
 */
public class objwwwsrvdns extends objwwwservice
{
    ...
    public void listproperty (dbdata oDBData, outdata oOutData)
    {
        ...
        oSQLData.setWhere ("WWWSERV_ID='" + SRV_DNS + "'");
    ...
    {
        oDBData.setVal (COL_WWWSERV_ID, SRV_DNS);
